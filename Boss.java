...
public class Boss extends BadGuys
{
    ...
    GreenfootImage monster1l = new GreenfootImage("person.png");
    GreenfootImage monster2l = new GreenfootImage("person.png");
    GreenfootImage monster3l = new GreenfootImage("person.png");
    GreenfootImage monster4l = new GreenfootImage("person.png");

    GreenfootImage monster1r = new GreenfootImage("person.png");
    GreenfootImage monster2r = new GreenfootImage("person.png");
    GreenfootImage monster3r = new GreenfootImage("person.png");
    GreenfootImage monster4r = new GreenfootImage("");
